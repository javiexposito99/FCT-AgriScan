...
<head>
    ...
    <link href="http://localhost/FCT/css/pag12.css" type="text/css" rel="stylesheet">
...
<body>
    ...
    <div class="cuadernoAgricola">Cuaderno Agrícola</div>
        ...
        <div class="panel-principal">
            ...
            <h2>DOCUMENTACIÓN A CONSERVAR JUNTO CON EL CUADERNO DE EXPLOTACIÓN</h2>    

            <p>Se conservarán junto al cuaderno de explotación durante al menos 3 años los siguientes documentos, según proceda:</p>
            
            <ul id="lista1">
                <li>Facturas u otros documentos que justifiquen la adquisición de los productos fitosanitarios utilizados.</li><br>
                <li>Contratos con las empresas o personas físicas que hayan realizado los tratamientos fitosanitarios.</li><br>
                <li>Certificados de inspección de los equipos de aplicación de producto fitosanitario.</li><br>
                <li>Justificantes de entrega de los envases vacíos de los productos fitosanitarios en el correspondiente punto de recogida.</li><br>
                <li>Boletines de análisis de residuos de productos fitosanitarios realizados sobre sus cultivos y producciones, y en su caso, agua de riego.</li><br>
                <li>Documentación relativa al asesoramiento recibido.</li><br>
                <li>Albaranes de entrega o facturas de venta de la cosecha.</li><br>
            </ul>
